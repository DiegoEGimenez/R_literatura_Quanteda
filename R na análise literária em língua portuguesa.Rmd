...
Códigos de R utilizados para a análise literária à distância em língua portuguesa (Giménez, 2024). Este documento atualiza e amplia uma versão prévia feita por Diego Giménez e Andressa Gomide em 2022 para a análise do "Livro do Desassossego"
